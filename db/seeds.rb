...
price_km: 0.2, price_weight: 0.007, price_dimensions: 50, deadline_km: 1, status: :active)
...
price_km: 0.15, price_weight: 0.005, price_dimensions: 90, deadline_km: 1, status: :active)
...
car_brand: 'VOLKS', max_weight: 100, shipping_company: shipping_company_3)
